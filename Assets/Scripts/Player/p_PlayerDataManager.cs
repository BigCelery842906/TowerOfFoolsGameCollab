...
public class p_PlayerDataManager : MonoBehaviour
{
    ...
    void PlayerDeathPositionUpdate(int playerID)
    {
        if(playerID == m_PlayerID)
        {
            ...
            Collider[] potetentialPlatforms = Physics.OverlapSphere(newPos, m_radius); //Get all objects in range that have a collider
            ...
            foreach (Collider platform in potetentialPlatforms)
            {
